...
controls = [
    ...
    dict(id_=32,  ccid='CC6.4',  crlg='CRLG#32', cat='cc6', title='Admin Access List',                   desc='A list of Okta admins and a list of AWS admins. Requires Okta and AWS admin access to export.',                                                                                          badge='auto',   tools=[], task='Review Okta and AWS IAM contexts for admin lists. For each admin: confirm business justification and last access date from CloudTrail. Flag any admins who have not logged in for 90+ days or lack MFA.'),
