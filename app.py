...
def _vet_vendor_impl():
    ...
    report_resp = client.messages.create(
        ...
        messages=[{"role": "user", "content":
            ...
            f"🌍 DATA & PRIVACY\n"
            f"5. Sub-processors — ✅/⚠️/❌ [listed publicly, customer notified of changes?]\n"
            f"6. Data Residency — ✅/⚠️/❌ [EU/US/other, customer control?]\n"
            f"7. Breach Notification — ✅/⚠️/❌ [72h GDPR SLA?]\n"
            f"8. Data Deletion — ✅/⚠️/❌ [full deletion post-termination, timeline?]\n\n"
            f"📋 CONTRACTUAL\n"
            f"9. DPA — ✅/⚠️/❌ [GDPR-compliant DPA available?]\n"
            f"10. Right to Audit — ✅/⚠️/❌ [customer or third-party audit rights?]\n"
            f"11. Liability Cap — ✅/⚠️/❌ [reasonable cap in contract?]\n\n"
            f"⚡ OPERATIONAL\n"
            f"12. Uptime SLA — ✅/⚠️/❌ [SLA %, financial credits?]\n"
            f"13. Disaster Recovery — ✅/⚠️/❌ [documented BCP/DR?]\n"
            f"14. Financial Stability — ✅/⚠️/❌ [publicly traded / stable / risk of shutdown?]\n\n"
            f"🎯 AI RISKS\n"
            f"15. Data Training — ✅/⚠️/❌ [does the vendor train AI/ML models on our data?]\n"
            f"16. Data Ownership — ✅/⚠️/❌ [is it verified our data always belongs to us?]\n"
